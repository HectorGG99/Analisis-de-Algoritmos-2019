...
public class TSP {
    ...
    private double costoMinimo = Double.POSITIVE_INFINITY;
    ...
    public void solucionar() {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (tourCost < costoMinimo) {
                costoMinimo = tourCost;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Camino: " + solver.getCamino());

        System.out.println("Costo del camino: " + solver.getCostoCamino());
    }
}
